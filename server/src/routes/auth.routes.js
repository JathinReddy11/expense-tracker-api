...
auth_Router.post('/login', loginLimiter, loginValidator, validateRequest, login);

auth_Router.patch('/update', authMiddleware, updateValidator, validateRequest, updateProfile);
